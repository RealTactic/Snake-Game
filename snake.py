...
while True:
    if X + 40 > screen_size[0]:
        X -= 40
    else:
        break
while True:
    if Y + 20 > screen_size[1] - 50:
        Y -= 20
    else:
        break
...
while True:
    ...
    if str(len(xthresh) / 2).endswith(".0"):
        X -= 20
    else:
        break

choose_middle = int((len(xthresh) - 1) / 2)
middle = xthresh[choose_middle]
